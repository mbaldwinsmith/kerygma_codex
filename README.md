...
- **INTRODUCTION** — a gentle overview and orientation. (`INTRODUCTION.md`)
- **MANIFESTO** — the covenant and vision of the Codex. (`MANIFESTO.md`)
- **SYSTEM_SPEC** — technical specification of the system grammar. (`SYSTEM_SPEC.md`)
- **CONTRIBUTING** — how to participate in this commons. (`CONTRIBUTING.md`)
- **Case Studies** — lived examples of repair ecology. (`case_studies/`)
